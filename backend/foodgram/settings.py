...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-REPLACE_ME')
...
# Добавляем настройку для обработки заголовков
...
AUTHENTICATION_BACKENDS = [
    'recipes.auth.EmailBackend',  # Наш кастомный бэкенд
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        'user_create_password_retype': 'recipes.serializers.CustomUserCreateSerializer',
