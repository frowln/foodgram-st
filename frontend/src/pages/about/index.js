    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/frowln/foodgram-st" target="_blank" rel="noopener noreferrer" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <span className={styles.textLink}>Касимов Дамир</span>
            </p>
          </div>
        </aside>
      </div>
